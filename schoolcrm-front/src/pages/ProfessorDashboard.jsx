        ...
        <>
            ...
            <div data-theme={dark ? "dark" : "light"} style={{ display:"flex", minHeight:"100vh", background: dark ? "#0f1a14" : "#f5f8f5" }}>
                ...
                <div style={{ flex:1, display:"flex", flexDirection:"column", minWidth:0 }}>
                    <header className="pd-header" style={{ background: dark ? "#131f1a" : "#fff", borderBottom:`1px solid ${dark ? "#1e3028" : "#eaeef2"}`, padding:"18px 32px",
                        ...
                        <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                            ...
                            <div style={{ width:32, height:32, background: dark ? "#243d30" : "#0d1f18", display:"flex", alignItems:"center",
